...
###################################
#import csv
#add=open('./train_reactant_dataset.csv','a+')
...
####################################################
                ...
                #for i,j in enumerate(reactant_dataset):
                    #c=[]
                    #c.append(i)
                    #c.append(j['seq'])
                    ##c.append(j['degree_attn_mask'])
                    ##c.append(j['laplacian_attn_mask'])
                    #c.append(len(j['seq']))
...
################################################################
            #for index in range(len(product_dataset)):
                #try:
                    #i=product_dataset[index]
                #except:
                    #with open('./fault1.txt','a+') as f:
                        #f.write(str(index)+'\n')
################################################################
            net_input = {
