...
from BioG2G.utils import utils as BioG2GUtils
from BioG2G.fairseq_modules import TransformerConfig
from BioG2G.fairseq_modules import LayerNorm, MultiheadAttention
from BioG2G.fairseq_modules.fairseq_dropout import FairseqDropout
    ...
    *cfg.decoder.normalize_before* to ``True``.
    ...
    def __init__(
        ...
        self.attn_ln = (
            ...
            if BioG2GUtils.safe_getattr(cfg, "scale_attn", False)
            else None
        )
        self.nh = self.self_attn.num_heads
        self.head_dim = self.self_attn.head_dim
        scale_heads = BioG2GUtils.safe_getattr(cfg, "scale_heads", False)
        self.c_attn = (
        ...
        self.ffn_layernorm = (
            ...
            if BioG2GUtils.safe_getattr(cfg, "scale_fc", False)
            else None
        )
        self.w_resid = (
            nn.Parameter(
            ...
            if BioG2GUtils.safe_getattr(cfg, "scale_resids", False)
            else None
        )
