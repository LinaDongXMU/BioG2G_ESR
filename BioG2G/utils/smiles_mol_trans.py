...
def check_all():
    ...
    p = "/data/fs_users/yaolin/BioG2G_dataset/dataset/BioG2G_/pistachio/pistachio_clean_dataset_s_filter_all/test.csv"
    # p = "/data/fs_projects/BioG2G/dataset/BioG2G_/USPTO50K_raw_20230220/test.csv"
    # p = "/data/fs_projects/BioG2G/dataset/synthesis/uspto_full_bek2/test.csv"
    df = pd.read_csv(p)
