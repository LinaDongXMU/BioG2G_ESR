...
from BioG2G.modules import seq2attn
...
@register_model_architecture("G2GT", "BioG2G_G2GT")
def BioG2G_G2GT_architecture(args):
    if __version__ == "1.5.0":
