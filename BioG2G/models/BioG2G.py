...
import math
from BioG2G.modules import MaskLMHead
from unicore.modules import init_bert_params, TransformerEncoder, TransformerDecoder
from BioG2G.decoder import TransformerDecoder as NewTransformerDecoder

logger = logging.getLogger(__name__)

flag_decoder_fairseq = True

from BioG2G.fairseq_modules.transformer_base import TransformerModelBase
# from BioG2G.fairseq_modules.transformer_decoder import TransformerDecoderBase
from BioG2G.fairseq_modules.transformer_config import (
    # TransformerConfig,
    gen_parser_from_dataclass,
)
from BioG2G.fairseq_decoder.transformer_config import TransformerConfig
from BioG2G.fairseq_decoder.transformer_decoder import TransformerDecoderBase
...
class BioG2GFBaseModel(BaseUnicoreModel):
    @staticmethod
    ...
    def add_args(parser):
        """Add model-specific arguments to the parser."""
        BioG2GFBaseModel.default_encoder_add_args(parser)
        if flag_decoder_fairseq:
            BioG2GFBaseModel.default_fairseq_add_args(parser)
        else:
            BioG2GFBaseModel.default_decoder_add_args_main(parser)
            BioG2GFBaseModel.default_decoder_add_args(parser)
            BioG2GFBaseModel.default_common_add_args(parser)
...
@register_model("BioG2GF")
class BioG2GFModel(BioG2GFBaseModel):
    @staticmethod
    def add_args(parser):
        BioG2GFBaseModel.add_args(parser)
        parser.add_argument(
            "--encoder-type",
            default="default",
...
@register_model_architecture("BioG2GF", "BioG2GF")
...
@register_model_architecture("BioG2GF", "BioG2GF_fairseq")
...
@register_model_architecture("BioG2GF", "BioG2GF_base")
def BioG2G_base_architecture(args):
    base_architecture(args)


@register_model_architecture("BioG2GF", "BioG2GF_unimol")
def BioG2G_unimol_architecture(args):
    args.encoder_type = "unimol"
    base_architecture(args)


@register_model_architecture("BioG2GF", "BioG2GF_DnU")
def BioG2G_default_and_unimol_architecture(args):
