...
from .BioG2G import BioG2GFModel, BioG2GFBaseModel, decoder_base_architecture
...
@register_model_architecture("G2G", "BioG2G_G2G")
def BioG2G_G2G_architecture(args):
    if __version__ == "1.5.0":
