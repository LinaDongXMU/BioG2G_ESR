...
def run(smiles, model_tuple, task_type='retrosynthesis', seed=42):
    ...
    # RMK:
    # from BioG2G.tasks.transformer_m import G2GTMTask
    # task = G2GTMTask()

    # subsets = ['train.small', 'train', 'valid']
    # data_path = '/data/projects/unimol/unimol_v1_data/examples/unimol_v2'
    # for subset in subsets:
    # subset = 'train'
    # task.load_dataset(subset, combine=False,
    #                     epoch=1, task_cfg=args.task, data_path=data_path)
    ...
    for i, sample in enumerate(itr):
        ...
        # print(result)
        write2file(smiles, results)
        return results


def load_smiles(subset='train.small'):
    path = '/data/users/qifanyu/nag2g_BioG2G/BioG2G_/unimol_v1_data'
    split_path = os.path.join(path, subset + '.json')
