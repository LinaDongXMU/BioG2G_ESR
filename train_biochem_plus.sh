...
[ -z "${n_gpu}" ] && n_gpu=2 #$(nvidia-smi -L | wc -l)
...
# [ -z "${init_train_path}" ] && init_train_path="/public/home/zjh/dln/BioG2G/outputs_biochem_plus/BioG2G_unimolplus_uspto_50k_b16_2_l6_vnode1_wda_true_lp_0_0_nsum2_false_sep2_false_cls_false_hdegree_true_fofalse_sg_randomsmiles_lr_2.5e-4_wd_0.0_mp__20251020-154844/checkpoint_last.pt"

time=$(date "+%Y%m%d-%H%M%S")
echo "time" $time
task_name='BioG2G_unimolplus_uspto_50k'
...
torchrun \
      ...
      --task G2G_unimolv2 --loss G2G --arch BioG2G_G2G --encoder-type unimolv2 --noise-scale ${noise_scale} --dict-name ${dict_name} \
	  ...
	  | tee -a ${log_save_dir}
#     --init_train_path ${init_train_path} \ 
