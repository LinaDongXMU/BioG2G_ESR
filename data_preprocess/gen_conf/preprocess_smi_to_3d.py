...
def inner_smi2coords(smi, num_confs=100, seed=42, cluster_size=10):
    ...
    return pickle.dumps(
        {"atoms": atoms, "coordinates": cluster_coordinate_list, "id": smi}, protocol=-1
    )
...
def write_lmdb(
    ...
    # smi_list = pd.read_csv(
    #     file_in,
    #     # names=["input"],  # nrows=100000
    # )["input"].tolist()
    ...
    for name, smi_list in task_list:
        ...
        with Pool(nthreads) as pool:
            ...
            for inner_output in tqdm(
                pool.imap(smi2coords, smi_list), total=len(smi_list)
            ):
...
if __name__ == "__main__":
    ...
    # write_lmdb(
    #     file_in="/data/projects/BioG2G/dataset/synthesis/uspto-full/extract/uspto_trainT.csv",
    #     outfile="uspto_trainT.lmdb",
    #     outpath="/data/projects/BioG2G/dataset/synthesis/uspto-full/extract/",
    #     nthreads=15,
    #     # range=(0, 10),
    # )
    nthreads = 108
    ...
    write_lmdb(
        ...
        outfile="train_3d.lmdb",
        outpath="/data/users/yaolin/BioG2G_/pistachio/pistachio_clean_dataset_filter_all/",
        nthreads=nthreads,
        # range=(0, 10),
    )
    # write_lmdb(
    #     file_in="/data/projects/BioG2G/dataset/synthesis/uspto-full/extract/uspto_valT.csv",
    #     outfile="uspto_valT.lmdb",
    #     outpath="/data/projects/BioG2G/dataset/synthesis/uspto-full/extract/",
    #     nthreads=15,
    #     # range=(0, 10),
    # )