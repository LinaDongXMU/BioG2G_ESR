[ -z "${MASTER_PORT}" ] && MASTER_PORT=12344
...
torchrun \
      ...
      BioG2G/validate.py $data_path --user-dir ./BioG2G \
      --valid-subset test \
...
python G2GT_cal.py ${results_path}/${new_filename} ${beam_size} --failed_samples ${s_flag}
cd -
